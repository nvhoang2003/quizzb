...
namespace QuizzBankBE.Services.ListQuestionServices
{
    public interface IQuestionBankList
    {
        ...
        Task<ServiceResponse<PageList<ListQuestion>>> GetListQuestion(OwnerParameter ownerParameters, int userLoginId, string? name, string? author,int? categoryId, string? tags, string? questionType, DateTime? startDate, DateTime? endDate);
